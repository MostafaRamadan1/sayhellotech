        ...
        <div className="space-y-[70px]">
          ...
          <div className="max-w-[680px] mx-auto text-center space-y-3">
            <RevealAnimation delay={0.2}>
              <span className="badge badge-green mb-5">We love to hear from you.</span>
            </RevealAnimation>
            <RevealAnimation delay={0.2}>
              <h2>Got a question or need a <span className="text-primary-500">hand?</span></h2>
            </RevealAnimation>
            <RevealAnimation delay={0.3}>
              <p>
                Our team’s just a message away, Whether it’s technical help, project guidance, or just saying hello —
                we’re always happy to connect and support you.
              </p>
            </RevealAnimation>
          </div>
          <div
            className="flex lg:items-start flex-col justify-center items-center gap-10 lg:flex-row lg:gap-8 xl:gap-[70px]">
            {/* contact info cards  */}
                  ...
                  <section key={item.id}>
                    <div
                      ...
                      <figure
                        ...
                        <Image src={item.gradient} alt="Decorative gradient overlay"
